                ...
                <table>
                    ...
                    <tbody>
                        {order.items && order.items.map((item, key) => (
                            <tr key={key} onClick={() => OnVisible(setVisible(true), setDisable(false), setIndex(item.id), setEditQuantity(item.quantity), setEditDataEntrega(order.data_entrega))} className='tr-hover'>
